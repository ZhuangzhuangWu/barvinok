...
/* polyacc Extended */
enum isl_polyacc_loop_type {
	isl_polyacc_loop_error = -1,
  isl_polyacc_loop_default = 0,
  isl_polyacc_loop_time,
  isl_polyacc_loop_spatial_x,
  isl_polyacc_loop_spatial_y,
  isl_polyacc_loop_spatial_z,
  isl_polyacc_loop_latency,
  isl_polyacc_loop_simd,
  isl_polyacc_loop_array_part	
};
/* polyacc Extended */
