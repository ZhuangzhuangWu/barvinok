...
/* Given union map with members (m1, m2, ..., mN),
 ...
 */
__isl_give isl_union_map *isl_union_map_wavefront(
	__isl_take isl_union_map *umap, int limit)
{
	...
	printf("[function] isl_union_map_wavefront\n");
	...
	isl_union_map *wavefront_umap = isl_union_map_from_basic_map(wavefront_bmap);
	isl_union_map *umap_tmp = isl_union_map_apply_range(umap,wavefront_umap);
